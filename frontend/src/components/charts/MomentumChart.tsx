    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="card p-3 text-center">
          <p className="text-xs text-chalk-500 uppercase tracking-wider mb-1">Longest Run</p>
        ...
        <div className="card p-3 text-center">
          <p className="text-xs text-chalk-500 uppercase tracking-wider mb-1">Lead Changes</p>
          <p className="font-mono text-2xl font-bold text-chalk-100">{stats.leadChanges}</p>
        </div>
        <div className="card p-3 text-center">
          <p className="text-xs text-chalk-500 uppercase tracking-wider mb-1">Largest Lead</p>
      ...
      <div className="card p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-4 text-xs text-chalk-500">
            ...
            <span className="flex items-center gap-1.5">
              <span className="w-3 h-1 rounded bg-slate-500 inline-block" /> {opponentName}
            </span>
          </div>
        </div>
        <ResponsiveContainer width="100%" height={220}>
          <AreaChart data={sample} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
            ...
            <XAxis
              ...
              tickLine={false}
              label={{ value: 'Points played', position: 'insideBottom', offset: -2, fill: '#64748b', fontSize: 10 }}
            />
            <YAxis
              domain={yDomain}
              tick={{ fill: '#94a3b8', fontSize: 10 }}
